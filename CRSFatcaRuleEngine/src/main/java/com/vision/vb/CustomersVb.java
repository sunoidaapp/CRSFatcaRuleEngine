...
public class CustomersVb extends CommonVb {
	...
	private String finalFatcaFlag = "N";
	private String finalCrsFlag = "N";
	private String dualNationality1 = "";
	private String dualNationality2 = "";
	private String dualNationality3 = "";
	private String fatcaMatchRef = "";
	private String crsMatchRef = "";
	
	public String getFatcaMatchRef() {
		return fatcaMatchRef;
	}

	public void setFatcaMatchRef(String fatcaMatchRef) {
		this.fatcaMatchRef = fatcaMatchRef;
	}

	public String getCrsMatchRef() {
		return crsMatchRef;
	}

	public void setCrsMatchRef(String crsMatchRef) {
		this.crsMatchRef = crsMatchRef;
	}

	public String getFinalFatcaFlag() {
		return finalFatcaFlag;
	}

	public void setFinalFatcaFlag(String finalFatcaFlag) {
		this.finalFatcaFlag = finalFatcaFlag;
	}

	public String getFinalCrsFlag() {
		return finalCrsFlag;
	}

	public void setFinalCrsFlag(String finalCrsFlag) {
		this.finalCrsFlag = finalCrsFlag;
	}
